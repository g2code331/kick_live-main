...
| If you want to…                                                      | Read                                                                                                                                                                                           |
| -------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| set everything up on a fresh account, in order                       | [`docs/SETUP_WALKTHROUGH.md`](docs/SETUP_WALKTHROUGH.md) — nine numbered steps, one command each, and the only doc to follow top to bottom                                                     |
...
| go live from a green repo (Cloudflare + GitHub + Supabase, in order) | [`docs/GO_LIVE.md`](docs/GO_LIVE.md) — one line per remaining action, with the proof each must print, and `npm run preflight:production` for the repo half                                     |
| deploy web + Worker                                                  | [`DEPLOYMENT.md`](DEPLOYMENT.md), [`DEPLOYMENT_CHECKLIST.md`](DEPLOYMENT_CHECKLIST.md)                                                                                                         |
| which file holds which key (the literal version)                     | [`docs/ENV-AND-KEYS.md`](docs/ENV-AND-KEYS.md) — `.env.local`, `workers/.dev.vars`, the Firebase halves, and how to prove each took                                                            |
| set up an environment, create a resource, set a key                  | [`docs/ENVIRONMENT_SETUP.md`](docs/ENVIRONMENT_SETUP.md) — every var, secret and binding, and the order that works                                                                             |
