...
| -------------------------- | -------- | -------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- |
| `VITE_SUPABASE_URL`        | **yes**  | `.env.staging` / `.env.production` (generated, tracked), `.env.local` to override, CI secret (per GitHub environment — staging ≠ production) | `src/lib/supabase.ts`                    | the SPA refuses to boot                                                                                                                            |
