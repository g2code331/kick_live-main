...
3. Rotate nothing yet. `repomix-output.xml` (and the `replit*`/`output.md` leftovers) were deleted and gitignored
   on 2026-09-13; `.vercel/` and `vercel.json` were removed on 2026-09-12 when the web host moved to Cloudflare Pages.
